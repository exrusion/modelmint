...
export function solTokenAccount(owner,mint=SOLANA_USDC_MINT){return getAssociatedTokenAddressSync(new PublicKey(mint),new PublicKey(owner)).toBase58();}
