...
const holderSettings=(await q('SELECT data FROM settings WHERE id=1')).rows[0].data;assert.equal(holderSettings.holderRewardsEnabled,true);assert.equal(holderSettings.holderRewardHoldSeconds,'43200');
